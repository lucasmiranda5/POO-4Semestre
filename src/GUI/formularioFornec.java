...
public class formularioFornec extends javax.swing.JFrame {
    ...
    public void acaoEditar(String id) throws BancoDeDadosException, SQLException{
       if(controller.existe(id)){
           ...
           textRazao.setText(arr.getRazaoSocial());
           textFantasia.setText(arr.getNomeFantasia());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       if(acao == "Adicionar"){
           ...
           try {
               retorno = controller.inserir(textCNPJ.getText(), textRazao.getText(), textFantasia.getText(), textTelefone.getText(), textRua.getText(), textBairro.getText(), textCidade.getText(),textRespon.getText());
           } catch (BancoDeDadosException ex) {
               Logger.getLogger(formularioFornec.class.getName()).log(Level.SEVERE, null, ex);
           }
            if(retorno){
            ...
            boolean retorno = false;
           try {
               retorno = controller.editar(textCodigo.getText(),textCNPJ.getText(), textRazao.getText(), textFantasia.getText(), textTelefone.getText(), textRua.getText(), textBairro.getText(), textCidade.getText(),textRespon.getText());
           } catch (BancoDeDadosException ex) {
               Logger.getLogger(formularioFornec.class.getName()).log(Level.SEVERE, null, ex);
           }
            if(retorno){
